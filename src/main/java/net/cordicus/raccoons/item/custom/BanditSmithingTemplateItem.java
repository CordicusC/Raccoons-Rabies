...
public class BanditSmithingTemplateItem extends SmithingTemplateItem {
    ...
    public static final Text BANDIT_UPGRADE_APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", RaccoonsRabies.id("smithing_template.bandit_upgrade.apply_to")))
            .formatted(DESCRIPTION_FORMAT);
    public static final Text BANDIT_UPGRADE_INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", RaccoonsRabies.id("smithing_template.bandit_upgrade.ingredients")))
            .formatted(DESCRIPTION_FORMAT);
    public static final Text BANDIT_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", RaccoonsRabies.id("bandit_upgrade")))
            .formatted(TITLE_FORMAT);
    public static final Text BANDIT_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", RaccoonsRabies.id("smithing_template.base_slot_description")));
    public static final Text BANDIT_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", RaccoonsRabies.id("smithing_template.additions_slot_description")));
    ...
    public static SmithingTemplateItem createBanditUpgrade(Item.Settings settings) {
