...
public class RaccoonHandheldItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        if (stack.get(RaccoonsRabiesItemComponents.RACCOON_ENTITY_DATA).baby()) {
            switch (raccoonType) {
                case 1: tooltip.add(Text.literal("Amethyst (Baby)").withColor((0xC890F0))); break;
                case 2: tooltip.add(Text.literal("Albino (Baby)").withColor((0x796A63))); break;
                case 4: tooltip.add(Text.literal("Cordicus (Baby)").withColor((0xfb6cc4))); break;
                case 5: tooltip.add(Text.literal("Nitron (Baby)").withColor((0xff004f))); break;
                case 6: tooltip.add(Text.literal("Bandit (Baby)").withColor((0x8C6E56))); break;
                case 7: tooltip.add(Text.literal("Yak (Baby)").withColor((0x3FC2EA))); break;
                case 8: tooltip.add(Text.literal("Rocket (Baby)").withColor((0x1B46DE))); break;
                default: tooltip.add(Text.literal("Normal (Baby)").formatted(Formatting.DARK_GRAY)); break;
            }
        }
        else {
            switch (raccoonType) {
                case 1: tooltip.add(Text.literal("Amethyst").withColor((0xC890F0))); break;
                case 2: tooltip.add(Text.literal("Albino").withColor((0x796A63))); break;
                case 4: tooltip.add(Text.literal("Cordicus").withColor((0xfb6cc4))); break;
                case 5: tooltip.add(Text.literal("Nitron").withColor((0xff004f))); break;
                case 6: tooltip.add(Text.literal("Bandit").withColor((0x8C6E56))); break;
                case 7: tooltip.add(Text.literal("Yak").withColor((0x3FC2EA))); break;
                case 8: tooltip.add(Text.literal("Rocket").withColor((0x1B46DE))); break;
